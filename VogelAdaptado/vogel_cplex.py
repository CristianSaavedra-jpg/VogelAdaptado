...
def uap_pulp(matriz,nombre):
    ...
    # SOLUCIÓN
    solver = pulp.getSolver('CPLEX_CMD') #asigancion del solver de CPLEX
    inicio=time.time() # inicio del conteo del tiempo
...
r_lit.close()
##Instancias Elegidas
nombres_200=carpeta+"nombres_200_todos.txt" #algunos de los 200 problemas
#nombres_200_algunos.txt es un archivo con los nombres de los problemas de los grupos de 200 instancias
...
f.close()
r_200.close()
# print(pulp.listSolvers(onlyAvailable=True)) #imprimir los solver habilitados
#Prueba de Hipotesis
