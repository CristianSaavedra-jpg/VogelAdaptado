...
def vogel_it(C,costos,posiciones,n_s,m_s,maq,lim,P_fila,P_col,n_max,indices_fila,indices_col,fila):
    #C = matriz de costos
    ...
    #fila = indicador si una fila fue tachada
    ...
    return C,costos,posiciones,n_s,m_s,maq,indices_fila,indices_col,P_fila,P_col,fila
...
def vogel(matriz): 
    ...
    while m_s>0: # el metodo itera hasta que todas las tareas esten asignadas
        ...
        C,costos,pos,n_s,m_s,maq,indices_fila,indices_col,P_fila,P_col,fila=vogel_it(C,costos,pos,n_s,m_s,maq,lim,P_fila,P_col,v_max,indices_fila,indices_col,fila)
